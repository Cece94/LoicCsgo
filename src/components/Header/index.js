        ...
        <div>
          <div onClick={removePaint}>
            ...
            >
              ...
              />
              <path
                d="M12.911 1.113c4.794 0 8.694 3.902 8.694 8.699 0 4.796-3.902 8.698-8.698 8.699-4.797-.001-8.7-3.903-8.7-8.699 0-4.797 3.902-8.699 8.701-8.699h.003M12.91 0h-.002-.002C7.488 0 3.093 4.394 3.093 9.813c0 5.417 4.396 9.812 9.813 9.813 5.416-.001 9.812-4.396 9.812-9.813C22.719 4.392 18.324 0 12.91 0z"
                fill="#2a2a31"
              />
              <circle cx="12.906" cy="9.812" r="1.296" fill="#2a2a31" />
              <path
                d="M14.906 20.812s-.379.313-2 .313-2-.313-2-.313c0 2.001-4 2.344-4 4v1h12v-1c0-1.656-4-1.999-4-4z"
                fill="#2a2a31"
              />
            </svg>
          </div>
          <h2>csgo matchmaking</h2>
          <a className="pluginName" href="https://github.com/splewis/get5">
            get 5 plugin
          </a>
        </div>
        <div className="headerMenu">
          <div
            className={`menu1 ${isMatchActive ? "active" : null}`}
            onClick={activateMatchMenu}
          >
            <span> Créer un Match</span>
          </div>
          <div
            className={`menu2 ${isTeamActive ? "active" : null}`}
            onClick={activateTeamMenu}
          >
